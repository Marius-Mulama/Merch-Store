...
if(!isset($_SESSION['user_name'])){
    if(isset($_SESSION['email_error']) or isset($_SESSION['password_error']) or isset($_SESSION['invalid_error']) or
    isset($_SESSION['id_error'])){
        session_destroy();
        $error = "<span class='alert alert-danger alert-dismissible' data-dismiss='alert' id='error'>
                        Invalid Seller Id Email or Password
                       </span>";
    }
...
<div class="card mx-auto card-info col-lg-6 col-md-8 col-sm-8 col-xl-4" style="padding: 1px; margin-top: 15px;">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form method="post" action="../authentication/seller/login.php">
        <div class="card-body">
            ...
            <div class="form-group row">
                <label for="seller-id" class="col-form-label col-12">Seller ID</label><br>
                <div class="col-12">
                    <input type="text" class="form-control" id="seller-id" name="seller-id" placeholder="Seller ID" required>
                </div>
        ...
        <div class="form-group text-center">
            ...
            <a href="reset.php">Forgot Your Credentials?</a>
        </div>
